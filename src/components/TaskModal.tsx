      ...
      <div className="modal">
        ...
        {addingSubject ? (
          ...
          <form onSubmit={submit} className="task-form task-form--enter" key="form">
            ...
            {/* Date & Time Input Row */}
            <div 
              className={`form-row form-row-datetime${isSubjectOpen ? ' is-hidden-for-subject' : ''}`}
              style={{
            ...
            >
              <div className="field">
                ...
                >
                  <svg className="picker-icon-left" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
